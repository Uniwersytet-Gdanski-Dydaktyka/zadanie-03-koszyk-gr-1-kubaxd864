error id: file:///C:/Users/x/Desktop/Projects/Github/UG/Java/zadanie-03-koszyk-gr-1-kubaxd864/Main.java:_empty_/PromotionEngine#applyBestPromotions().
file:///C:/Users/x/Desktop/Projects/Github/UG/Java/zadanie-03-koszyk-gr-1-kubaxd864/Main.java
empty definition using pc, found symbol in pc: _empty_/PromotionEngine#applyBestPromotions().
...
public class Main {
    public static void main(String[] args) {
        ...
        // Sortowanie domyślne (po cenie malejąco, potem alfabetycznie)
        basket.defaultSort();
        ...
        Basket bestBasket = PromotionEngine.a@@pplyBestPromotions(basket, promos);
