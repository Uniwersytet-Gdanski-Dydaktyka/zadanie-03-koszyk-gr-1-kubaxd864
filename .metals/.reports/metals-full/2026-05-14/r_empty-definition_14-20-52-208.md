error id: file:///C:/Users/x/Desktop/Projects/Github/UG/Java/zadanie-03-koszyk-gr-1-kubaxd864/Basket.java:java/util/Comparator#
...
public class Basket {
    ...
    public void sortProducts(Comparator<Product> comparator) {
        products.sort(C@@omparator.comparingDouble(Product::getPrice).reversed()
