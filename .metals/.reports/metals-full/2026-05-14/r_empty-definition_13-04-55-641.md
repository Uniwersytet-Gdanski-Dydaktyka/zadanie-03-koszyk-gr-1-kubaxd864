error id: file:///C:/Users/x/Desktop/Projects/Github/UG/Java/zadanie-03-koszyk-gr-1-kubaxd864/BuyTwoGetOneFreePromotion.java:java/util/List#set().
file:///C:/Users/x/Desktop/Projects/Github/UG/Java/zadanie-03-koszyk-gr-1-kubaxd864/BuyTwoGetOneFreePromotion.java
empty definition using pc, found symbol in pc: java/util/List#set().
    ...
    public List<Product> apply(List<Product> products) {
        ...
        for (int i = 0; i < sortedByDiscount.size(); i++) {
            ...
            if (p.getDiscountPrice() > 0) {
                sortedByDiscount.se@@t(i, p.copyWithDiscountPrice(0.0));
